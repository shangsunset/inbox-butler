...
class Inbox():
    ...
    def get_subscriptions(self):
        url = 'https://www.googleapis.com/gmail/v1/users/{}/messages?q=category:(promotions+OR+primary)+newer_than:7d'.format(self.user_id)
        messages = []
    ...
    def create_message(self, to, sender, subject, merchant):
        message = MIMEText('This mail is automatically generated by Inbox Butler to unsubscribe from {}'.format(merchant))
        message['to'] = to
        message['from'] = sender
